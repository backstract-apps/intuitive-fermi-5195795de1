...
async def auth_package_middleware(request: Request) -> Dict[str, Any]:
    ...
    Generated from middleware ID: mid_1d65b5f917684324ba82e128ccf4a5f0
    """
    try:
        ...
        auth_package_secret_key = """hx-d_16oC38uba_vqmcTET50KXkz0Ju_2Dqt-9KrtEY="""
...
async def cors_middleware(request: Request) -> Dict[str, Any]:
    """
    CORS Middleware
    Generated from middleware ID: mid_0684ce04c1b240159487194057f98aa1
    """
    try:
