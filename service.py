...
async def post_platform_auth_package_mayson_auth_user_login(
    ...
    secret_key = """hx-d_16oC38uba_vqmcTET50KXkz0Ju_2Dqt-9KrtEY="""
    bs_jwt_payload = {
...
async def post_tasks(
    ...
    completed_at_dt: str = convert_to_datetime(raw_data.completed_at_dt)
    created_at_dt: str = convert_to_datetime(raw_data.created_at_dt)
...
async def get_platform_auth_package_mayson_sso_auth_me(
    ...
    try:
        user_profile = jwt.decode(
            auth_header,
            """hx-d_16oC38uba_vqmcTET50KXkz0Ju_2Dqt-9KrtEY=""",
            algorithms=["HS256"],
        )
    ...
    try:
        ...
        async def google_login():
            async with httpx.AsyncClient() as client:
                headers = {
                    "Authorization": "Bearer v4.public.-HpOqIg8cVRYMwpELn3VG-glgh3iDoLvNUUI-2YIBES63Qm2gu7DWcmBZSc_dNfow3GaFIK",
                    "Content-Type": "application/json",
                }

                res = await client.get(
                    "https://api.beemerbenzbentley.site/sigma/api/v1/sso/auth/google/login?collection_id=coll_8988b194455245ab92ba9aff8b6a795a",
                    headers=headers,
                )
